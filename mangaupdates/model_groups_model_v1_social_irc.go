...
// checks if the GroupsModelV1SocialIrc type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupsModelV1SocialIrc{}
...
type NullableGroupsModelV1SocialIrc struct {
	value *GroupsModelV1SocialIrc
	isSet bool
}

func (v NullableGroupsModelV1SocialIrc) Get() *GroupsModelV1SocialIrc {
	return v.value
}

func (v *NullableGroupsModelV1SocialIrc) Set(val *GroupsModelV1SocialIrc) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupsModelV1SocialIrc) IsSet() bool {
	return v.isSet
}
...
func NewNullableGroupsModelV1SocialIrc(val *GroupsModelV1SocialIrc) *NullableGroupsModelV1SocialIrc {
	return &NullableGroupsModelV1SocialIrc{value: val, isSet: true}
}
