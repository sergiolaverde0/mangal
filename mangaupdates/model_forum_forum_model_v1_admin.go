...
// checks if the ForumForumModelV1Admin type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ForumForumModelV1Admin{}
...
type NullableForumForumModelV1Admin struct {
	value *ForumForumModelV1Admin
	isSet bool
}

func (v NullableForumForumModelV1Admin) Get() *ForumForumModelV1Admin {
	return v.value
}

func (v *NullableForumForumModelV1Admin) Set(val *ForumForumModelV1Admin) {
	v.value = val
	v.isSet = true
}

func (v NullableForumForumModelV1Admin) IsSet() bool {
	return v.isSet
}
...
func NewNullableForumForumModelV1Admin(val *ForumForumModelV1Admin) *NullableForumForumModelV1Admin {
	return &NullableForumForumModelV1Admin{value: val, isSet: true}
}
