...
// checks if the CategoriesModelUpdateV1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CategoriesModelUpdateV1{}
...
type NullableCategoriesModelUpdateV1 struct {
	value *CategoriesModelUpdateV1
	isSet bool
}

func (v NullableCategoriesModelUpdateV1) Get() *CategoriesModelUpdateV1 {
	return v.value
}

func (v *NullableCategoriesModelUpdateV1) Set(val *CategoriesModelUpdateV1) {
	v.value = val
	v.isSet = true
}

func (v NullableCategoriesModelUpdateV1) IsSet() bool {
	return v.isSet
}

func (v *NullableCategoriesModelUpdateV1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCategoriesModelUpdateV1(val *CategoriesModelUpdateV1) *NullableCategoriesModelUpdateV1 {
	return &NullableCategoriesModelUpdateV1{value: val, isSet: true}
}
