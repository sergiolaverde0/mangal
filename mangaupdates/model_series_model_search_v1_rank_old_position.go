...
// checks if the SeriesModelSearchV1RankOldPosition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SeriesModelSearchV1RankOldPosition{}
...
func NewSeriesModelSearchV1RankOldPosition() *SeriesModelSearchV1RankOldPosition {
	this := SeriesModelSearchV1RankOldPosition{}
	return &this
}
...
type NullableSeriesModelSearchV1RankOldPosition struct {
	value *SeriesModelSearchV1RankOldPosition
	isSet bool
}

func (v NullableSeriesModelSearchV1RankOldPosition) Get() *SeriesModelSearchV1RankOldPosition {
	return v.value
}

func (v *NullableSeriesModelSearchV1RankOldPosition) Set(val *SeriesModelSearchV1RankOldPosition) {
	v.value = val
	v.isSet = true
}

func (v NullableSeriesModelSearchV1RankOldPosition) IsSet() bool {
	return v.isSet
}

func (v *NullableSeriesModelSearchV1RankOldPosition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSeriesModelSearchV1RankOldPosition(val *SeriesModelSearchV1RankOldPosition) *NullableSeriesModelSearchV1RankOldPosition {
	return &NullableSeriesModelSearchV1RankOldPosition{value: val, isSet: true}
}

func (v NullableSeriesModelSearchV1RankOldPosition) MarshalJSON() ([]byte, error) {
