...
// checks if the AuthorsSearchResponseV1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthorsSearchResponseV1{}
...
func (o *AuthorsSearchResponseV1) GetResults() []AuthorsSearchResponseV1Results {
	if o == nil || IsNil(o.Results) {
		var ret []AuthorsSearchResponseV1Results
		return ret
	}
	return o.Results
}
...
type NullableAuthorsSearchResponseV1 struct {
	value *AuthorsSearchResponseV1
	isSet bool
}

func (v NullableAuthorsSearchResponseV1) Get() *AuthorsSearchResponseV1 {
	return v.value
}

func (v *NullableAuthorsSearchResponseV1) Set(val *AuthorsSearchResponseV1) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthorsSearchResponseV1) IsSet() bool {
	return v.isSet
}

func (v *NullableAuthorsSearchResponseV1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuthorsSearchResponseV1(val *AuthorsSearchResponseV1) *NullableAuthorsSearchResponseV1 {
	return &NullableAuthorsSearchResponseV1{value: val, isSet: true}
}
