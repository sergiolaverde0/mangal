...
// checks if the UserModelV1Profile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserModelV1Profile{}
...
func (o *UserModelV1Profile) GetUpgrade() UserModelV1ProfileUpgrade {
	if o == nil || IsNil(o.Upgrade) {
		var ret UserModelV1ProfileUpgrade
		return ret
	}
	return *o.Upgrade
}
...
type NullableUserModelV1Profile struct {
	value *UserModelV1Profile
	isSet bool
}

func (v NullableUserModelV1Profile) Get() *UserModelV1Profile {
	return v.value
}

func (v *NullableUserModelV1Profile) Set(val *UserModelV1Profile) {
	v.value = val
	v.isSet = true
}
...
func NewNullableUserModelV1Profile(val *UserModelV1Profile) *NullableUserModelV1Profile {
	return &NullableUserModelV1Profile{value: val, isSet: true}
}
