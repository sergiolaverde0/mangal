...
// checks if the GenreModelV1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenreModelV1{}
...
func (v NullableGenreModelV1) Get() *GenreModelV1 {
	return v.value
}
...
func NewNullableGenreModelV1(val *GenreModelV1) *NullableGenreModelV1 {
	return &NullableGenreModelV1{value: val, isSet: true}
}
