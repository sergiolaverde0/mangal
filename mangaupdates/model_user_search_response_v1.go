...
// checks if the UserSearchResponseV1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserSearchResponseV1{}
...
func (o *UserSearchResponseV1) GetResults() []UserSearchResponseV1Results {
	if o == nil || IsNil(o.Results) {
		var ret []UserSearchResponseV1Results
		return ret
	}
	return o.Results
}
...
type NullableUserSearchResponseV1 struct {
	value *UserSearchResponseV1
	isSet bool
}

func (v NullableUserSearchResponseV1) Get() *UserSearchResponseV1 {
	return v.value
}

func (v *NullableUserSearchResponseV1) Set(val *UserSearchResponseV1) {
	v.value = val
	v.isSet = true
}

func (v NullableUserSearchResponseV1) IsSet() bool {
	return v.isSet
}
...
func NewNullableUserSearchResponseV1(val *UserSearchResponseV1) *NullableUserSearchResponseV1 {
	return &NullableUserSearchResponseV1{value: val, isSet: true}
}
