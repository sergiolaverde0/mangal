...
// checks if the PublishersModelV1Stats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PublishersModelV1Stats{}
...
type NullablePublishersModelV1Stats struct {
	value *PublishersModelV1Stats
	isSet bool
}

func (v NullablePublishersModelV1Stats) Get() *PublishersModelV1Stats {
	return v.value
}

func (v *NullablePublishersModelV1Stats) Set(val *PublishersModelV1Stats) {
	v.value = val
	v.isSet = true
}

func (v NullablePublishersModelV1Stats) IsSet() bool {
	return v.isSet
}
...
func NewNullablePublishersModelV1Stats(val *PublishersModelV1Stats) *NullablePublishersModelV1Stats {
	return &NullablePublishersModelV1Stats{value: val, isSet: true}
}
