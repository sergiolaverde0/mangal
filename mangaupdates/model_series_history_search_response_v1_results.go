...
// checks if the SeriesHistorySearchResponseV1Results type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SeriesHistorySearchResponseV1Results{}
...
func NewSeriesHistorySearchResponseV1Results() *SeriesHistorySearchResponseV1Results {
	this := SeriesHistorySearchResponseV1Results{}
	return &this
}
...
type NullableSeriesHistorySearchResponseV1Results struct {
	value *SeriesHistorySearchResponseV1Results
	isSet bool
}

func (v NullableSeriesHistorySearchResponseV1Results) Get() *SeriesHistorySearchResponseV1Results {
	return v.value
}

func (v *NullableSeriesHistorySearchResponseV1Results) Set(val *SeriesHistorySearchResponseV1Results) {
	v.value = val
	v.isSet = true
}

func (v NullableSeriesHistorySearchResponseV1Results) IsSet() bool {
	return v.isSet
}

func (v *NullableSeriesHistorySearchResponseV1Results) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSeriesHistorySearchResponseV1Results(val *SeriesHistorySearchResponseV1Results) *NullableSeriesHistorySearchResponseV1Results {
	return &NullableSeriesHistorySearchResponseV1Results{value: val, isSet: true}
}

func (v NullableSeriesHistorySearchResponseV1Results) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSeriesHistorySearchResponseV1Results) UnmarshalJSON(src []byte) error {
	v.isSet = true
