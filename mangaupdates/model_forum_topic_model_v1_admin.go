...
// checks if the ForumTopicModelV1Admin type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ForumTopicModelV1Admin{}
...
type NullableForumTopicModelV1Admin struct {
	value *ForumTopicModelV1Admin
	isSet bool
}

func (v NullableForumTopicModelV1Admin) Get() *ForumTopicModelV1Admin {
	return v.value
}

func (v *NullableForumTopicModelV1Admin) Set(val *ForumTopicModelV1Admin) {
	v.value = val
	v.isSet = true
}

func (v NullableForumTopicModelV1Admin) IsSet() bool {
	return v.isSet
}
...
func NewNullableForumTopicModelV1Admin(val *ForumTopicModelV1Admin) *NullableForumTopicModelV1Admin {
	return &NullableForumTopicModelV1Admin{value: val, isSet: true}
}
