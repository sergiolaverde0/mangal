...
// checks if the FaqCategoryReorderModelV1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FaqCategoryReorderModelV1{}
...
func NewFaqCategoryReorderModelV1(categoryId int64) *FaqCategoryReorderModelV1 {
	this := FaqCategoryReorderModelV1{}
...
func (o *FaqCategoryReorderModelV1) GetQuestions() []FaqQuestionReorderModelV1 {
	if o == nil || IsNil(o.Questions) {
		var ret []FaqQuestionReorderModelV1
		return ret
	}
	return o.Questions
}
...
type NullableFaqCategoryReorderModelV1 struct {
	value *FaqCategoryReorderModelV1
	isSet bool
}

func (v NullableFaqCategoryReorderModelV1) Get() *FaqCategoryReorderModelV1 {
	return v.value
}

func (v *NullableFaqCategoryReorderModelV1) Set(val *FaqCategoryReorderModelV1) {
	v.value = val
	v.isSet = true
}

func (v NullableFaqCategoryReorderModelV1) IsSet() bool {
	return v.isSet
}

func (v *NullableFaqCategoryReorderModelV1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFaqCategoryReorderModelV1(val *FaqCategoryReorderModelV1) *NullableFaqCategoryReorderModelV1 {
	return &NullableFaqCategoryReorderModelV1{value: val, isSet: true}
}
