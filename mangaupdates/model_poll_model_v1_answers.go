...
// checks if the PollModelV1Answers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PollModelV1Answers{}
...
type NullablePollModelV1Answers struct {
	value *PollModelV1Answers
	isSet bool
}

func (v NullablePollModelV1Answers) Get() *PollModelV1Answers {
	return v.value
}

func (v *NullablePollModelV1Answers) Set(val *PollModelV1Answers) {
	v.value = val
	v.isSet = true
}
...
func NewNullablePollModelV1Answers(val *PollModelV1Answers) *NullablePollModelV1Answers {
	return &NullablePollModelV1Answers{value: val, isSet: true}
}
