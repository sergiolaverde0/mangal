...
// checks if the ReleaseSearchResponseV1ResultsMetadataUserGenreHighlights type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReleaseSearchResponseV1ResultsMetadataUserGenreHighlights{}
...
func NewReleaseSearchResponseV1ResultsMetadataUserGenreHighlights() *ReleaseSearchResponseV1ResultsMetadataUserGenreHighlights {
	this := ReleaseSearchResponseV1ResultsMetadataUserGenreHighlights{}
	return &this
}
...
func (o ReleaseSearchResponseV1ResultsMetadataUserGenreHighlights) MarshalJSON() ([]byte, error) {
...
func (o ReleaseSearchResponseV1ResultsMetadataUserGenreHighlights) ToMap() (map[string]interface{}, error) {
...
type NullableReleaseSearchResponseV1ResultsMetadataUserGenreHighlights struct {
	value *ReleaseSearchResponseV1ResultsMetadataUserGenreHighlights
	isSet bool
}

func (v NullableReleaseSearchResponseV1ResultsMetadataUserGenreHighlights) Get() *ReleaseSearchResponseV1ResultsMetadataUserGenreHighlights {
	return v.value
}

func (v *NullableReleaseSearchResponseV1ResultsMetadataUserGenreHighlights) Set(val *ReleaseSearchResponseV1ResultsMetadataUserGenreHighlights) {
	v.value = val
	v.isSet = true
}

func (v NullableReleaseSearchResponseV1ResultsMetadataUserGenreHighlights) IsSet() bool {
	return v.isSet
}

func (v *NullableReleaseSearchResponseV1ResultsMetadataUserGenreHighlights) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReleaseSearchResponseV1ResultsMetadataUserGenreHighlights(val *ReleaseSearchResponseV1ResultsMetadataUserGenreHighlights) *NullableReleaseSearchResponseV1ResultsMetadataUserGenreHighlights {
	return &NullableReleaseSearchResponseV1ResultsMetadataUserGenreHighlights{value: val, isSet: true}
}

func (v NullableReleaseSearchResponseV1ResultsMetadataUserGenreHighlights) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReleaseSearchResponseV1ResultsMetadataUserGenreHighlights) UnmarshalJSON(src []byte) error {
	v.isSet = true
