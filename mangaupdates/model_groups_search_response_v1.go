...
// checks if the GroupsSearchResponseV1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupsSearchResponseV1{}
...
func (o *GroupsSearchResponseV1) GetResults() []GroupsSearchResponseV1Results {
	if o == nil || IsNil(o.Results) {
		var ret []GroupsSearchResponseV1Results
		return ret
	}
	return o.Results
}
...
type NullableGroupsSearchResponseV1 struct {
	value *GroupsSearchResponseV1
	isSet bool
}

func (v NullableGroupsSearchResponseV1) Get() *GroupsSearchResponseV1 {
	return v.value
}

func (v *NullableGroupsSearchResponseV1) Set(val *GroupsSearchResponseV1) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupsSearchResponseV1) IsSet() bool {
	return v.isSet
}
...
func NewNullableGroupsSearchResponseV1(val *GroupsSearchResponseV1) *NullableGroupsSearchResponseV1 {
	return &NullableGroupsSearchResponseV1{value: val, isSet: true}
}
