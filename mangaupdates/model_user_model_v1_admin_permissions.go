...
// checks if the UserModelV1AdminPermissions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserModelV1AdminPermissions{}
...
func NewUserModelV1AdminPermissions() *UserModelV1AdminPermissions {
	this := UserModelV1AdminPermissions{}
	return &this
}
...
type NullableUserModelV1AdminPermissions struct {
	value *UserModelV1AdminPermissions
	isSet bool
}

func (v NullableUserModelV1AdminPermissions) Get() *UserModelV1AdminPermissions {
	return v.value
}

func (v *NullableUserModelV1AdminPermissions) Set(val *UserModelV1AdminPermissions) {
	v.value = val
	v.isSet = true
}

func (v NullableUserModelV1AdminPermissions) IsSet() bool {
	return v.isSet
}

func (v *NullableUserModelV1AdminPermissions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserModelV1AdminPermissions(val *UserModelV1AdminPermissions) *NullableUserModelV1AdminPermissions {
	return &NullableUserModelV1AdminPermissions{value: val, isSet: true}
}
