...
// checks if the PublishersSearchRequestV1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PublishersSearchRequestV1{}
...
// NewPublishersSearchRequestV1 instantiates a new PublishersSearchRequestV1 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPublishersSearchRequestV1() *PublishersSearchRequestV1 {
	this := PublishersSearchRequestV1{}
	return &this
}

// NewPublishersSearchRequestV1WithDefaults instantiates a new PublishersSearchRequestV1 object
...
type NullablePublishersSearchRequestV1 struct {
	value *PublishersSearchRequestV1
	isSet bool
}

func (v NullablePublishersSearchRequestV1) Get() *PublishersSearchRequestV1 {
	return v.value
}

func (v *NullablePublishersSearchRequestV1) Set(val *PublishersSearchRequestV1) {
	v.value = val
	v.isSet = true
}

func (v NullablePublishersSearchRequestV1) IsSet() bool {
	return v.isSet
}

func (v *NullablePublishersSearchRequestV1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublishersSearchRequestV1(val *PublishersSearchRequestV1) *NullablePublishersSearchRequestV1 {
	return &NullablePublishersSearchRequestV1{value: val, isSet: true}
}
