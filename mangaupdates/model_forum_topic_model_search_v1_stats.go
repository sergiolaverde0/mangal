...
// checks if the ForumTopicModelSearchV1Stats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ForumTopicModelSearchV1Stats{}
...
func NewForumTopicModelSearchV1Stats() *ForumTopicModelSearchV1Stats {
	this := ForumTopicModelSearchV1Stats{}
	return &this
}
...
type NullableForumTopicModelSearchV1Stats struct {
	value *ForumTopicModelSearchV1Stats
	isSet bool
}

func (v NullableForumTopicModelSearchV1Stats) Get() *ForumTopicModelSearchV1Stats {
	return v.value
}

func (v *NullableForumTopicModelSearchV1Stats) Set(val *ForumTopicModelSearchV1Stats) {
	v.value = val
	v.isSet = true
}

func (v NullableForumTopicModelSearchV1Stats) IsSet() bool {
	return v.isSet
}

func (v *NullableForumTopicModelSearchV1Stats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableForumTopicModelSearchV1Stats(val *ForumTopicModelSearchV1Stats) *NullableForumTopicModelSearchV1Stats {
	return &NullableForumTopicModelSearchV1Stats{value: val, isSet: true}
}
