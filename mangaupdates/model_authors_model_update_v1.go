...
// checks if the AuthorsModelUpdateV1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthorsModelUpdateV1{}
...
func (o *AuthorsModelUpdateV1) GetAssociated() []AuthorsModelUpdateV1Associated {
	if o == nil || IsNil(o.Associated) {
		var ret []AuthorsModelUpdateV1Associated
		return ret
	}
	return o.Associated
}
...
func (o *AuthorsModelUpdateV1) GetSocial() AuthorsModelUpdateV1Social {
	if o == nil || IsNil(o.Social) {
		var ret AuthorsModelUpdateV1Social
		return ret
	}
	return *o.Social
}
...
func (o *AuthorsModelUpdateV1) GetAdmin() AuthorsModelUpdateV1Admin {
	if o == nil || IsNil(o.Admin) {
		var ret AuthorsModelUpdateV1Admin
		return ret
	}
	return *o.Admin
}
...
type NullableAuthorsModelUpdateV1 struct {
	value *AuthorsModelUpdateV1
	isSet bool
}

func (v NullableAuthorsModelUpdateV1) Get() *AuthorsModelUpdateV1 {
	return v.value
}

func (v *NullableAuthorsModelUpdateV1) Set(val *AuthorsModelUpdateV1) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthorsModelUpdateV1) IsSet() bool {
	return v.isSet
}
...
func NewNullableAuthorsModelUpdateV1(val *AuthorsModelUpdateV1) *NullableAuthorsModelUpdateV1 {
	return &NullableAuthorsModelUpdateV1{value: val, isSet: true}
}
