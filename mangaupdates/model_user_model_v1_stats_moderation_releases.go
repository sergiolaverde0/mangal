...
// checks if the UserModelV1StatsModerationReleases type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserModelV1StatsModerationReleases{}
...
func NewUserModelV1StatsModerationReleases() *UserModelV1StatsModerationReleases {
	this := UserModelV1StatsModerationReleases{}
	return &this
}
...
type NullableUserModelV1StatsModerationReleases struct {
	value *UserModelV1StatsModerationReleases
	isSet bool
}

func (v NullableUserModelV1StatsModerationReleases) Get() *UserModelV1StatsModerationReleases {
	return v.value
}

func (v *NullableUserModelV1StatsModerationReleases) Set(val *UserModelV1StatsModerationReleases) {
	v.value = val
	v.isSet = true
}

func (v NullableUserModelV1StatsModerationReleases) IsSet() bool {
	return v.isSet
}

func (v *NullableUserModelV1StatsModerationReleases) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserModelV1StatsModerationReleases(val *UserModelV1StatsModerationReleases) *NullableUserModelV1StatsModerationReleases {
	return &NullableUserModelV1StatsModerationReleases{value: val, isSet: true}
}

func (v NullableUserModelV1StatsModerationReleases) MarshalJSON() ([]byte, error) {
