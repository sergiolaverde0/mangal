...
// checks if the AvatarModelV1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvatarModelV1{}
...
func (v NullableAvatarModelV1) Get() *AvatarModelV1 {
	return v.value
}
...
func NewNullableAvatarModelV1(val *AvatarModelV1) *NullableAvatarModelV1 {
	return &NullableAvatarModelV1{value: val, isSet: true}
}
