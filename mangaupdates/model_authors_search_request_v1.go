...
// checks if the AuthorsSearchRequestV1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthorsSearchRequestV1{}
...
type NullableAuthorsSearchRequestV1 struct {
	value *AuthorsSearchRequestV1
	isSet bool
}

func (v NullableAuthorsSearchRequestV1) Get() *AuthorsSearchRequestV1 {
	return v.value
}

func (v *NullableAuthorsSearchRequestV1) Set(val *AuthorsSearchRequestV1) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthorsSearchRequestV1) IsSet() bool {
	return v.isSet
}
...
func NewNullableAuthorsSearchRequestV1(val *AuthorsSearchRequestV1) *NullableAuthorsSearchRequestV1 {
	return &NullableAuthorsSearchRequestV1{value: val, isSet: true}
}
