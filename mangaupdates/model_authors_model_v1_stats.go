...
// checks if the AuthorsModelV1Stats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthorsModelV1Stats{}
...
type NullableAuthorsModelV1Stats struct {
	value *AuthorsModelV1Stats
	isSet bool
}

func (v NullableAuthorsModelV1Stats) Get() *AuthorsModelV1Stats {
	return v.value
}

func (v *NullableAuthorsModelV1Stats) Set(val *AuthorsModelV1Stats) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthorsModelV1Stats) IsSet() bool {
	return v.isSet
}
...
func NewNullableAuthorsModelV1Stats(val *AuthorsModelV1Stats) *NullableAuthorsModelV1Stats {
	return &NullableAuthorsModelV1Stats{value: val, isSet: true}
}
