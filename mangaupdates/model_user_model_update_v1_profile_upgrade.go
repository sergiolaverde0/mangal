...
// checks if the UserModelUpdateV1ProfileUpgrade type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserModelUpdateV1ProfileUpgrade{}
...
func NewUserModelUpdateV1ProfileUpgrade() *UserModelUpdateV1ProfileUpgrade {
	this := UserModelUpdateV1ProfileUpgrade{}
	return &this
}
...
type NullableUserModelUpdateV1ProfileUpgrade struct {
	value *UserModelUpdateV1ProfileUpgrade
	isSet bool
}

func (v NullableUserModelUpdateV1ProfileUpgrade) Get() *UserModelUpdateV1ProfileUpgrade {
	return v.value
}

func (v *NullableUserModelUpdateV1ProfileUpgrade) Set(val *UserModelUpdateV1ProfileUpgrade) {
	v.value = val
	v.isSet = true
}

func (v NullableUserModelUpdateV1ProfileUpgrade) IsSet() bool {
	return v.isSet
}

func (v *NullableUserModelUpdateV1ProfileUpgrade) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserModelUpdateV1ProfileUpgrade(val *UserModelUpdateV1ProfileUpgrade) *NullableUserModelUpdateV1ProfileUpgrade {
	return &NullableUserModelUpdateV1ProfileUpgrade{value: val, isSet: true}
}
