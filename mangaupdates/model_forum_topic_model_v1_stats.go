...
// checks if the ForumTopicModelV1Stats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ForumTopicModelV1Stats{}
...
type NullableForumTopicModelV1Stats struct {
	value *ForumTopicModelV1Stats
	isSet bool
}

func (v NullableForumTopicModelV1Stats) Get() *ForumTopicModelV1Stats {
	return v.value
}

func (v *NullableForumTopicModelV1Stats) Set(val *ForumTopicModelV1Stats) {
	v.value = val
	v.isSet = true
}

func (v NullableForumTopicModelV1Stats) IsSet() bool {
	return v.isSet
}
...
func NewNullableForumTopicModelV1Stats(val *ForumTopicModelV1Stats) *NullableForumTopicModelV1Stats {
	return &NullableForumTopicModelV1Stats{value: val, isSet: true}
}
