...
// checks if the PublishersSearchResponseV1Results type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PublishersSearchResponseV1Results{}
...
func NewPublishersSearchResponseV1Results() *PublishersSearchResponseV1Results {
	this := PublishersSearchResponseV1Results{}
	return &this
}
...
func (o *PublishersSearchResponseV1Results) GetRecord() PublishersModelSearchV1 {
	if o == nil || IsNil(o.Record) {
		var ret PublishersModelSearchV1
		return ret
	}
	return *o.Record
}
...
type NullablePublishersSearchResponseV1Results struct {
	value *PublishersSearchResponseV1Results
	isSet bool
}

func (v NullablePublishersSearchResponseV1Results) Get() *PublishersSearchResponseV1Results {
	return v.value
}

func (v *NullablePublishersSearchResponseV1Results) Set(val *PublishersSearchResponseV1Results) {
	v.value = val
	v.isSet = true
}

func (v NullablePublishersSearchResponseV1Results) IsSet() bool {
	return v.isSet
}

func (v *NullablePublishersSearchResponseV1Results) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublishersSearchResponseV1Results(val *PublishersSearchResponseV1Results) *NullablePublishersSearchResponseV1Results {
	return &NullablePublishersSearchResponseV1Results{value: val, isSet: true}
}

func (v NullablePublishersSearchResponseV1Results) MarshalJSON() ([]byte, error) {
