...
// checks if the ReviewModelSearchV1Review type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReviewModelSearchV1Review{}
...
func NewReviewModelSearchV1Review() *ReviewModelSearchV1Review {
	this := ReviewModelSearchV1Review{}
	return &this
}
...
type NullableReviewModelSearchV1Review struct {
	value *ReviewModelSearchV1Review
	isSet bool
}

func (v NullableReviewModelSearchV1Review) Get() *ReviewModelSearchV1Review {
	return v.value
}

func (v *NullableReviewModelSearchV1Review) Set(val *ReviewModelSearchV1Review) {
	v.value = val
	v.isSet = true
}

func (v NullableReviewModelSearchV1Review) IsSet() bool {
	return v.isSet
}

func (v *NullableReviewModelSearchV1Review) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReviewModelSearchV1Review(val *ReviewModelSearchV1Review) *NullableReviewModelSearchV1Review {
	return &NullableReviewModelSearchV1Review{value: val, isSet: true}
}
