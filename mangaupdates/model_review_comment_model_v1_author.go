...
// checks if the ReviewCommentModelV1Author type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReviewCommentModelV1Author{}
...
func NewReviewCommentModelV1Author() *ReviewCommentModelV1Author {
	this := ReviewCommentModelV1Author{}
	return &this
}
...
type NullableReviewCommentModelV1Author struct {
	value *ReviewCommentModelV1Author
	isSet bool
}

func (v NullableReviewCommentModelV1Author) Get() *ReviewCommentModelV1Author {
	return v.value
}

func (v *NullableReviewCommentModelV1Author) Set(val *ReviewCommentModelV1Author) {
	v.value = val
	v.isSet = true
}

func (v NullableReviewCommentModelV1Author) IsSet() bool {
	return v.isSet
}

func (v *NullableReviewCommentModelV1Author) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReviewCommentModelV1Author(val *ReviewCommentModelV1Author) *NullableReviewCommentModelV1Author {
	return &NullableReviewCommentModelV1Author{value: val, isSet: true}
}
