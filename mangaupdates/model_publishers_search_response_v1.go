...
// checks if the PublishersSearchResponseV1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PublishersSearchResponseV1{}
...
func NewPublishersSearchResponseV1() *PublishersSearchResponseV1 {
	this := PublishersSearchResponseV1{}
	return &this
}
...
func (o *PublishersSearchResponseV1) GetResults() []PublishersSearchResponseV1Results {
	if o == nil || IsNil(o.Results) {
		var ret []PublishersSearchResponseV1Results
		return ret
	}
	return o.Results
}
...
type NullablePublishersSearchResponseV1 struct {
	value *PublishersSearchResponseV1
	isSet bool
}

func (v NullablePublishersSearchResponseV1) Get() *PublishersSearchResponseV1 {
	return v.value
}

func (v *NullablePublishersSearchResponseV1) Set(val *PublishersSearchResponseV1) {
	v.value = val
	v.isSet = true
}

func (v NullablePublishersSearchResponseV1) IsSet() bool {
	return v.isSet
}

func (v *NullablePublishersSearchResponseV1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePublishersSearchResponseV1(val *PublishersSearchResponseV1) *NullablePublishersSearchResponseV1 {
	return &NullablePublishersSearchResponseV1{value: val, isSet: true}
}
