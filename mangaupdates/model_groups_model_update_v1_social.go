...
// checks if the GroupsModelUpdateV1Social type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupsModelUpdateV1Social{}
...
func NewGroupsModelUpdateV1Social() *GroupsModelUpdateV1Social {
	this := GroupsModelUpdateV1Social{}
	return &this
}
...
func (o *GroupsModelUpdateV1Social) GetIrc() GroupsModelUpdateV1SocialIrc {
	if o == nil || IsNil(o.Irc) {
		var ret GroupsModelUpdateV1SocialIrc
		return ret
	}
	return *o.Irc
}
...
type NullableGroupsModelUpdateV1Social struct {
	value *GroupsModelUpdateV1Social
	isSet bool
}

func (v NullableGroupsModelUpdateV1Social) Get() *GroupsModelUpdateV1Social {
	return v.value
}

func (v *NullableGroupsModelUpdateV1Social) Set(val *GroupsModelUpdateV1Social) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupsModelUpdateV1Social) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupsModelUpdateV1Social) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupsModelUpdateV1Social(val *GroupsModelUpdateV1Social) *NullableGroupsModelUpdateV1Social {
	return &NullableGroupsModelUpdateV1Social{value: val, isSet: true}
}
