...
// checks if the ListsSeriesModelUpdateV1Series type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListsSeriesModelUpdateV1Series{}
...
func NewListsSeriesModelUpdateV1Series(id int64) *ListsSeriesModelUpdateV1Series {
	this := ListsSeriesModelUpdateV1Series{}
	this.Id = id
	return &this
}
...
type NullableListsSeriesModelUpdateV1Series struct {
	value *ListsSeriesModelUpdateV1Series
	isSet bool
}

func (v NullableListsSeriesModelUpdateV1Series) Get() *ListsSeriesModelUpdateV1Series {
	return v.value
}

func (v *NullableListsSeriesModelUpdateV1Series) Set(val *ListsSeriesModelUpdateV1Series) {
	v.value = val
	v.isSet = true
}

func (v NullableListsSeriesModelUpdateV1Series) IsSet() bool {
	return v.isSet
}

func (v *NullableListsSeriesModelUpdateV1Series) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListsSeriesModelUpdateV1Series(val *ListsSeriesModelUpdateV1Series) *NullableListsSeriesModelUpdateV1Series {
	return &NullableListsSeriesModelUpdateV1Series{value: val, isSet: true}
}
