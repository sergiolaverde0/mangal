...
// checks if the UserModelV1StatsModerationAuthors type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserModelV1StatsModerationAuthors{}
...
func NewUserModelV1StatsModerationAuthors() *UserModelV1StatsModerationAuthors {
	this := UserModelV1StatsModerationAuthors{}
	return &this
}
...
type NullableUserModelV1StatsModerationAuthors struct {
	value *UserModelV1StatsModerationAuthors
	isSet bool
}

func (v NullableUserModelV1StatsModerationAuthors) Get() *UserModelV1StatsModerationAuthors {
	return v.value
}

func (v *NullableUserModelV1StatsModerationAuthors) Set(val *UserModelV1StatsModerationAuthors) {
	v.value = val
	v.isSet = true
}

func (v NullableUserModelV1StatsModerationAuthors) IsSet() bool {
	return v.isSet
}

func (v *NullableUserModelV1StatsModerationAuthors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserModelV1StatsModerationAuthors(val *UserModelV1StatsModerationAuthors) *NullableUserModelV1StatsModerationAuthors {
	return &NullableUserModelV1StatsModerationAuthors{value: val, isSet: true}
}

func (v NullableUserModelV1StatsModerationAuthors) MarshalJSON() ([]byte, error) {
