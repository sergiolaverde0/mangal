...
// checks if the FaqCategoryModelUpdateV1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FaqCategoryModelUpdateV1{}
...
type NullableFaqCategoryModelUpdateV1 struct {
	value *FaqCategoryModelUpdateV1
	isSet bool
}

func (v NullableFaqCategoryModelUpdateV1) Get() *FaqCategoryModelUpdateV1 {
	return v.value
}

func (v *NullableFaqCategoryModelUpdateV1) Set(val *FaqCategoryModelUpdateV1) {
	v.value = val
	v.isSet = true
}

func (v NullableFaqCategoryModelUpdateV1) IsSet() bool {
	return v.isSet
}

func (v *NullableFaqCategoryModelUpdateV1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFaqCategoryModelUpdateV1(val *FaqCategoryModelUpdateV1) *NullableFaqCategoryModelUpdateV1 {
	return &NullableFaqCategoryModelUpdateV1{value: val, isSet: true}
}
