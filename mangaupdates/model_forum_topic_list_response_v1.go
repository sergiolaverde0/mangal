...
// checks if the ForumTopicListResponseV1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ForumTopicListResponseV1{}
...
func (o *ForumTopicListResponseV1) GetResults() []ForumTopicListResponseV1Results {
	if o == nil || IsNil(o.Results) {
		var ret []ForumTopicListResponseV1Results
		return ret
	}
	return o.Results
}
...
type NullableForumTopicListResponseV1 struct {
	value *ForumTopicListResponseV1
	isSet bool
}

func (v NullableForumTopicListResponseV1) Get() *ForumTopicListResponseV1 {
	return v.value
}

func (v *NullableForumTopicListResponseV1) Set(val *ForumTopicListResponseV1) {
	v.value = val
	v.isSet = true
}

func (v NullableForumTopicListResponseV1) IsSet() bool {
	return v.isSet
}

func (v *NullableForumTopicListResponseV1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableForumTopicListResponseV1(val *ForumTopicListResponseV1) *NullableForumTopicListResponseV1 {
	return &NullableForumTopicListResponseV1{value: val, isSet: true}
}
