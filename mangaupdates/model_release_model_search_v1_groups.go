...
// checks if the ReleaseModelSearchV1Groups type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReleaseModelSearchV1Groups{}
...
func NewReleaseModelSearchV1Groups() *ReleaseModelSearchV1Groups {
	this := ReleaseModelSearchV1Groups{}
	return &this
}
...
type NullableReleaseModelSearchV1Groups struct {
	value *ReleaseModelSearchV1Groups
	isSet bool
}

func (v NullableReleaseModelSearchV1Groups) Get() *ReleaseModelSearchV1Groups {
	return v.value
}

func (v *NullableReleaseModelSearchV1Groups) Set(val *ReleaseModelSearchV1Groups) {
	v.value = val
	v.isSet = true
}

func (v NullableReleaseModelSearchV1Groups) IsSet() bool {
	return v.isSet
}

func (v *NullableReleaseModelSearchV1Groups) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReleaseModelSearchV1Groups(val *ReleaseModelSearchV1Groups) *NullableReleaseModelSearchV1Groups {
	return &NullableReleaseModelSearchV1Groups{value: val, isSet: true}
}
