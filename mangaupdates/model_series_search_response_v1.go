...
// checks if the SeriesSearchResponseV1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SeriesSearchResponseV1{}
...
func (o *SeriesSearchResponseV1) GetResults() []SeriesSearchResponseV1Results {
	if o == nil || IsNil(o.Results) {
		var ret []SeriesSearchResponseV1Results
		return ret
	}
	return o.Results
}
...
type NullableSeriesSearchResponseV1 struct {
	value *SeriesSearchResponseV1
	isSet bool
}

func (v NullableSeriesSearchResponseV1) Get() *SeriesSearchResponseV1 {
	return v.value
}

func (v *NullableSeriesSearchResponseV1) Set(val *SeriesSearchResponseV1) {
	v.value = val
	v.isSet = true
}

func (v NullableSeriesSearchResponseV1) IsSet() bool {
	return v.isSet
}
...
func NewNullableSeriesSearchResponseV1(val *SeriesSearchResponseV1) *NullableSeriesSearchResponseV1 {
	return &NullableSeriesSearchResponseV1{value: val, isSet: true}
}
