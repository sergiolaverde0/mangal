...
// checks if the GroupsModelV1Associated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupsModelV1Associated{}
...
type NullableGroupsModelV1Associated struct {
	value *GroupsModelV1Associated
	isSet bool
}

func (v NullableGroupsModelV1Associated) Get() *GroupsModelV1Associated {
	return v.value
}

func (v *NullableGroupsModelV1Associated) Set(val *GroupsModelV1Associated) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupsModelV1Associated) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupsModelV1Associated) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupsModelV1Associated(val *GroupsModelV1Associated) *NullableGroupsModelV1Associated {
	return &NullableGroupsModelV1Associated{value: val, isSet: true}
}
