...
// checks if the AboutusCategoryModelUpdateV1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AboutusCategoryModelUpdateV1{}
...
func NewAboutusCategoryModelUpdateV1() *AboutusCategoryModelUpdateV1 {
	this := AboutusCategoryModelUpdateV1{}
	return &this
}
...
type NullableAboutusCategoryModelUpdateV1 struct {
	value *AboutusCategoryModelUpdateV1
	isSet bool
}

func (v NullableAboutusCategoryModelUpdateV1) Get() *AboutusCategoryModelUpdateV1 {
	return v.value
}

func (v *NullableAboutusCategoryModelUpdateV1) Set(val *AboutusCategoryModelUpdateV1) {
	v.value = val
	v.isSet = true
}

func (v NullableAboutusCategoryModelUpdateV1) IsSet() bool {
	return v.isSet
}

func (v *NullableAboutusCategoryModelUpdateV1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAboutusCategoryModelUpdateV1(val *AboutusCategoryModelUpdateV1) *NullableAboutusCategoryModelUpdateV1 {
	return &NullableAboutusCategoryModelUpdateV1{value: val, isSet: true}
}
