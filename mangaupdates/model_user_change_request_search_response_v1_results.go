...
// checks if the UserChangeRequestSearchResponseV1Results type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserChangeRequestSearchResponseV1Results{}
...
func NewUserChangeRequestSearchResponseV1Results() *UserChangeRequestSearchResponseV1Results {
	this := UserChangeRequestSearchResponseV1Results{}
	return &this
}
...
func (o *UserChangeRequestSearchResponseV1Results) GetRecord() UserChangeRequestModelV1 {
	if o == nil || IsNil(o.Record) {
		var ret UserChangeRequestModelV1
		return ret
	}
	return *o.Record
}
...
func (o UserChangeRequestSearchResponseV1Results) MarshalJSON() ([]byte, error) {
...
type NullableUserChangeRequestSearchResponseV1Results struct {
	value *UserChangeRequestSearchResponseV1Results
	isSet bool
}

func (v NullableUserChangeRequestSearchResponseV1Results) Get() *UserChangeRequestSearchResponseV1Results {
	return v.value
}

func (v *NullableUserChangeRequestSearchResponseV1Results) Set(val *UserChangeRequestSearchResponseV1Results) {
	v.value = val
	v.isSet = true
}

func (v NullableUserChangeRequestSearchResponseV1Results) IsSet() bool {
	return v.isSet
}

func (v *NullableUserChangeRequestSearchResponseV1Results) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserChangeRequestSearchResponseV1Results(val *UserChangeRequestSearchResponseV1Results) *NullableUserChangeRequestSearchResponseV1Results {
	return &NullableUserChangeRequestSearchResponseV1Results{value: val, isSet: true}
}

func (v NullableUserChangeRequestSearchResponseV1Results) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserChangeRequestSearchResponseV1Results) UnmarshalJSON(src []byte) error {
	v.isSet = true
