...
// checks if the UserSearchResponseV1Results type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserSearchResponseV1Results{}
...
func NewUserSearchResponseV1Results() *UserSearchResponseV1Results {
	this := UserSearchResponseV1Results{}
	return &this
}
...
type NullableUserSearchResponseV1Results struct {
	value *UserSearchResponseV1Results
	isSet bool
}

func (v NullableUserSearchResponseV1Results) Get() *UserSearchResponseV1Results {
	return v.value
}

func (v *NullableUserSearchResponseV1Results) Set(val *UserSearchResponseV1Results) {
	v.value = val
	v.isSet = true
}

func (v NullableUserSearchResponseV1Results) IsSet() bool {
	return v.isSet
}

func (v *NullableUserSearchResponseV1Results) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserSearchResponseV1Results(val *UserSearchResponseV1Results) *NullableUserSearchResponseV1Results {
	return &NullableUserSearchResponseV1Results{value: val, isSet: true}
}
