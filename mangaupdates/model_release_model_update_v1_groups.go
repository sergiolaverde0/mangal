...
// checks if the ReleaseModelUpdateV1Groups type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReleaseModelUpdateV1Groups{}
...
func NewReleaseModelUpdateV1Groups() *ReleaseModelUpdateV1Groups {
	this := ReleaseModelUpdateV1Groups{}
	return &this
}
...
type NullableReleaseModelUpdateV1Groups struct {
	value *ReleaseModelUpdateV1Groups
	isSet bool
}

func (v NullableReleaseModelUpdateV1Groups) Get() *ReleaseModelUpdateV1Groups {
	return v.value
}

func (v *NullableReleaseModelUpdateV1Groups) Set(val *ReleaseModelUpdateV1Groups) {
	v.value = val
	v.isSet = true
}

func (v NullableReleaseModelUpdateV1Groups) IsSet() bool {
	return v.isSet
}

func (v *NullableReleaseModelUpdateV1Groups) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReleaseModelUpdateV1Groups(val *ReleaseModelUpdateV1Groups) *NullableReleaseModelUpdateV1Groups {
	return &NullableReleaseModelUpdateV1Groups{value: val, isSet: true}
}
