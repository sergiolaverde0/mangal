...
// checks if the ReviewModelUpdateV1Review type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReviewModelUpdateV1Review{}
...
func NewReviewModelUpdateV1Review() *ReviewModelUpdateV1Review {
	this := ReviewModelUpdateV1Review{}
	return &this
}
...
type NullableReviewModelUpdateV1Review struct {
	value *ReviewModelUpdateV1Review
	isSet bool
}

func (v NullableReviewModelUpdateV1Review) Get() *ReviewModelUpdateV1Review {
	return v.value
}

func (v *NullableReviewModelUpdateV1Review) Set(val *ReviewModelUpdateV1Review) {
	v.value = val
	v.isSet = true
}

func (v NullableReviewModelUpdateV1Review) IsSet() bool {
	return v.isSet
}

func (v *NullableReviewModelUpdateV1Review) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReviewModelUpdateV1Review(val *ReviewModelUpdateV1Review) *NullableReviewModelUpdateV1Review {
	return &NullableReviewModelUpdateV1Review{value: val, isSet: true}
}
