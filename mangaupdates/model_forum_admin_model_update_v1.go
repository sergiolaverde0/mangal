...
// checks if the ForumAdminModelUpdateV1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ForumAdminModelUpdateV1{}
...
type NullableForumAdminModelUpdateV1 struct {
	value *ForumAdminModelUpdateV1
	isSet bool
}

func (v NullableForumAdminModelUpdateV1) Get() *ForumAdminModelUpdateV1 {
	return v.value
}

func (v *NullableForumAdminModelUpdateV1) Set(val *ForumAdminModelUpdateV1) {
	v.value = val
	v.isSet = true
}

func (v NullableForumAdminModelUpdateV1) IsSet() bool {
	return v.isSet
}

func (v *NullableForumAdminModelUpdateV1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableForumAdminModelUpdateV1(val *ForumAdminModelUpdateV1) *NullableForumAdminModelUpdateV1 {
	return &NullableForumAdminModelUpdateV1{value: val, isSet: true}
}
