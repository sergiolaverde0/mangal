...
// checks if the SeriesHistorySearchResponseV1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SeriesHistorySearchResponseV1{}
...
func NewSeriesHistorySearchResponseV1() *SeriesHistorySearchResponseV1 {
	this := SeriesHistorySearchResponseV1{}
	return &this
}
...
func (o *SeriesHistorySearchResponseV1) GetResults() []SeriesHistorySearchResponseV1Results {
	if o == nil || IsNil(o.Results) {
		var ret []SeriesHistorySearchResponseV1Results
		return ret
	}
	return o.Results
}
...
type NullableSeriesHistorySearchResponseV1 struct {
	value *SeriesHistorySearchResponseV1
	isSet bool
}

func (v NullableSeriesHistorySearchResponseV1) Get() *SeriesHistorySearchResponseV1 {
	return v.value
}

func (v *NullableSeriesHistorySearchResponseV1) Set(val *SeriesHistorySearchResponseV1) {
	v.value = val
	v.isSet = true
}

func (v NullableSeriesHistorySearchResponseV1) IsSet() bool {
	return v.isSet
}

func (v *NullableSeriesHistorySearchResponseV1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSeriesHistorySearchResponseV1(val *SeriesHistorySearchResponseV1) *NullableSeriesHistorySearchResponseV1 {
	return &NullableSeriesHistorySearchResponseV1{value: val, isSet: true}
}
