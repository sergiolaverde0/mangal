...
// checks if the AuthorsModelV1Associated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthorsModelV1Associated{}
...
type NullableAuthorsModelV1Associated struct {
	value *AuthorsModelV1Associated
	isSet bool
}

func (v NullableAuthorsModelV1Associated) Get() *AuthorsModelV1Associated {
	return v.value
}

func (v *NullableAuthorsModelV1Associated) Set(val *AuthorsModelV1Associated) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthorsModelV1Associated) IsSet() bool {
	return v.isSet
}

func (v *NullableAuthorsModelV1Associated) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuthorsModelV1Associated(val *AuthorsModelV1Associated) *NullableAuthorsModelV1Associated {
	return &NullableAuthorsModelV1Associated{value: val, isSet: true}
}
