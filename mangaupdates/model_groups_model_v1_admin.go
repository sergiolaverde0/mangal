...
// checks if the GroupsModelV1Admin type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupsModelV1Admin{}
...
type NullableGroupsModelV1Admin struct {
	value *GroupsModelV1Admin
	isSet bool
}

func (v NullableGroupsModelV1Admin) Get() *GroupsModelV1Admin {
	return v.value
}

func (v *NullableGroupsModelV1Admin) Set(val *GroupsModelV1Admin) {
	v.value = val
	v.isSet = true
}
...
func NewNullableGroupsModelV1Admin(val *GroupsModelV1Admin) *NullableGroupsModelV1Admin {
	return &NullableGroupsModelV1Admin{value: val, isSet: true}
}
