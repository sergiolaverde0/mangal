...
## 4.8.1
- Dependencies are now vendored to allow this project to be built with nix
...
## 4.5.7
- Fix issue with downloader having multiple time the same pages
- Make WebP converter split page bigger than 2000px in height

## 4.5.6
- Don't cache empty chapters

## 4.5.5
- Fix downloading chromium

## 4.5.4
- Fix issue with asurascans that changed domain name

## 4.5.3
- Fix issue where not everything was closed when mangal stops

## 4.5.2
- Fix mangaleo source

## 4.5.1
- Improve the performance of Rod and FlareSolverr
